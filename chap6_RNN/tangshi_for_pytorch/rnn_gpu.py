...
class word_embedding(nn.Module):
    def __init__(self, vocab_length, embedding_dim):
        ...
        self.word_embedding.weight.data.copy_(torch.from_numpy(w_embeding_random_intial).float())

    def forward(self, input_sentence):
        """
        :param input_sentence: a tensor that contains several word indices.
        :return: a tensor that contains word embeddings.
        """
